...
class FavDetailActivity : AppCompatActivity(), FavDetailInterface {
    private var resEventList: MutableList<Event> = mutableListOf()
    private lateinit var prevPresenter: FavDetailPresenter
    ...
    fun init() {
        ...
        val gson = Gson()
        prevPresenter = FavDetailPresenter(this, request, gson)
    ...
    override fun setEvent(event: List<Event>) {
        resEvent = event[0]
        setView()
    }
